...
A su vez, dentro de un archivo \emph{Makefile} del proyecto definimos un conjunto de comandos que sirven para levantar \emph{NERd}.
...
Si el cliente tiene un \emph{token} de \emph{refresh}, en la figura \ref{fig:scenarios-relogin} podemos ver el flujo que realiza la implementación \emph{web} del entrenador para realizar el refresco de la sesión.
...
{\centering \includegraphics{nerd-pf_files/figure-latex/scenarios-ner2-1.pdf} 

}

\caption{Flujo de relogin}\label{fig:scenarios-ner2}
\end{figure}
...
\caption{Flujo de relogin}\label{fig:scenarios-ner}
\end{figure}

\hypertarget{worker-entrenamiento-del-modelo}{%
\subsubsection{\texorpdfstring{\emph{Worker}: Entrenamiento del modelo}{Worker: Entrenamiento del modelo}}\label{worker-entrenamiento-del-modelo}}

\hypertarget{worker-cambio-de-modelo}{%
\subsubsection{\texorpdfstring{\emph{Worker}: cambio de modelo}{Worker: cambio de modelo}}\label{worker-cambio-de-modelo}}

\hypertarget{worker-semuxe1foro}{%
\subsubsection{\texorpdfstring{\emph{Worker}: Semáforo}{Worker: Semáforo}}\label{worker-semuxe1foro}}
