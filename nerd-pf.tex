...
\item
  ...
  \tightlist
  \item
    Borra un texto especificado por \emph{text\_id} del \emph{corpus}.
  \end{itemize}
\item
...
\item
  ...
  \tightlist
  \item
    Envía la tarea de entrenamiento a los workers que tienen el \emph{snapshot} \emph{snapshot\_id} cargado.
  \end{itemize}
\item
