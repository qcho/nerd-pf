...
\hypersetup{unicode=true,
            pdftitle={Creación eficiente de modelos estadísticos para detección de entidades nombradas},
...
\setlength{\droptitle}{-2em}
  ...
  \title{Creación eficiente de modelos estadísticos para detección de entidades nombradas}
...
\begin{titlepage}
    \begin{center}
        ...
        \Huge
        \textbf{Creación eficiente de modelos estadísticos para detección de entidades nombradas}
