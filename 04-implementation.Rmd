...
El servicio que provee el _API REST_ fue implementado utilizando el lenguaje de programación _Python_. El principal motivador de esta elección fue que las librerías que más cercan al estado del arte se encuentran implementadas en este lenguaje.

Como base del proyecto, utilizamos un framework llamado _Flask_, que junto con una librería llamada _flask-smorest_ nos permitió crear un _API REST_ 
