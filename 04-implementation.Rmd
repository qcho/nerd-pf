...
* **GET** _/api/users/top5_
    * Lista de los cinco usuarios con más entrenamientos.
* **GET** _/api/users/me_
...
* **DELETE** _/api/corpus/\{text\_id\}_
    * Borra un texto especificado por _text\_id_ del _corpus_.
...
* **POST** _/api/snapshots/\{snapshot_id}/force-train_
    * Envía la tarea de entrenamiento a los workers que tienen el _snapshot_ _snapshot_id_ cargado.
