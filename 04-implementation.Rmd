...
knitr::include_graphics('assets/logic/home-logged-all.pdf')
```
...
knitr::include_graphics('assets/logic/home-logged-not_trainer.pdf')
```
...
knitr::include_graphics('assets/logic/home-anonymous.pdf')
```
...
knitr::include_graphics('assets/logic/train.pdf')
```
...
knitr::include_graphics('assets/logic/train-help.pdf')
```
...
knitr::include_graphics('assets/logic/train-popup.pdf')
```
...
knitr::include_graphics('assets/logic/user-list.pdf')
```
...
knitr::include_graphics('assets/logic/user-profile.pdf')
```
...
knitr::include_graphics('assets/logic/corpus-management.pdf')
```
...
knitr::include_graphics('assets/logic/status.pdf')
```
...
knitr::include_graphics('assets/logic/sandbox.pdf')
```
...
knitr::include_graphics('assets/logic/compare.pdf')
```
