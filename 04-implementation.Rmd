...
Cuando el sistema entrena un _snapshot_ se tendrá en cuenta todos los textos que hayan sido etiquetados previamente a la creación del mismo.
...
```{r scenarios-worker-train, results = 'asis', echo = FALSE, fig.pos="H", fig.align = 'center', fig.cap='Bloqueo de entrenamiento por lectura.'}
...
Debido a que requieren de un _snapshot_ para poder realizar la tarea de _NER_ así como también requieren del _corpus_ etiquetado para poder entrenar el modelo, cada _worker_ debe tener acceso a la base de datos principal de _NERd_ (Figura \@ref(fig:process-overview-client)).
