...
Es la interfaz del entrenador que se comunica con el API utilizando un _SDK_ auto-generado a partir de la definición de _OpenAPI_. Implementado en este proyecto es un cliente _web_ el cual permite explotar las funcionalidades de entrenamiento así como de inferencia de entidades.
