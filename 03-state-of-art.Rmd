...
Cada componente del pipeline devuelve el _Doc_ procesado, que luego se pasa al siguiente componente.
...
En particular, _spaCy_ posee algoritmo de tokenización inteligente que puede ser resumido de la siguiente manera:
...
Esto permite al modelo poder inferir significado a partir de la información no etiquetada dentro del problema en particular a resolver (el de _NER_).
